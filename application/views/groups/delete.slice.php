			...
			<div class="card-body">
				...
				<form class="forms-sample" method="POST" action="{{$BASE_URL.'delete_process'}}">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="Group Name" name="name" value="{{$result['name']}}" disabled>
					</div>
					<div class="form-group">
						<label for="exampleInputName1">Group Desc</label>
						<input type="text" class="form-control" placeholder="Group Desc" name="description" value="{{$result['description']}}" disabled>
					</div>
					<div class="form-group">
						<label for="exampleInputName1">Default Page</label>
						<input type="text" class="form-control" placeholder="Default Page" name="default_page" value="{{$result['default_page']}}" disabled>
					</div>
